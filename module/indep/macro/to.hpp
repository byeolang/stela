...
namespace by {
     ...
     *  @details `TO` supports the safe navigation features of modern languages very intuitively and
     ...
     *      @endcode
     *
     *      and what if there are funcs utilize above structs.
     ...
     *          @endcode
     *
     *  @remark as you can see, it looks easy to use, but there are a few things that you should be
     *  aware of.
     *      1. the previously mentioned `<expression>` does not simply mean pointers and
     *      references, but also includes classes that satisfy the following conditions.
     *
     ...
     *                  TO(getColorCode()) OR.err("code is null").ret(-1)
     *              return code;
     *          }
     *      @endcode
     */
