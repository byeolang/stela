...
// nonterminal:
//  basic component:
%type <asStela> compilation-unit
//      expr:
//          normal:
%type <asStela> expr-inline expr-inline5 unary
//          def:
%type <asStela> def-expr-inline def-expr-compound
//      stmt:
%type <asStela> def-stmt
//      block:
%type <asStela> indentDefBlock defblock
%type <asStela> def-stmt-chain
//      tuple:
%type <asStela> tuple-items tuple-item
//      type:
%type <asStela> access type
//  keyword:
//      define:
//          value:
%type <asStela> def-prop-inline def-prop-value
//          obj:
%type <asStela> def-obj def-obj-default
//              container:
%type <asStela> def-array-value
